    ...
    <main class="main-wrapper">
                            ...
                            <div class="axil-product product-style-four">
                                <div class="thumbnail">
                                    <a href="{{ route('details-produits', ['id' => $produit->id, 'slug' => Str::slug(Str::limit($produit->nom, 10))]) }}">
                                        <img data-sal="zoom-out" data-sal-delay="100" data-sal-duration="1500" src="{{ Storage::url($produit->photo) }}" alt="Product Images">
                                        <style>
                                            .top-right {
                                                position: absolute;
                                                top: 8px;
                                        ...
                                        @if ($produit->inPromotion())
                                            <div class="top-right"
                                                style="background-color:#ec0f0f;color: white;">
                                    ...
                                    <div class="product-hover-action">
                                        <ul class="cart-action">
                                            ...
                                            <li class="wishlist top-left"><a onclick="AddFavoris({{ $produit->id }})"
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        <h5 class="title"><a href="{{ route('details-produits', ['id' => $produit->id, 'slug' => Str::slug(Str::limit($produit->nom, 10))]) }}"> {{ \App\Helpers\TranslationHelper::TranslateText($produit->nom) }}</a></h5>
        ...
        <div class="axil-best-seller-product-area bg-color-white axil-section-gap pb--0">
            <div class="container">
                <div class="product-area pb--50">
                    <div class="section-title-wrapper">
                        <span class="title-highlighter highlighter-primary"> <i class="far fa-shopping-basket"></i> {{ \App\Helpers\TranslationHelper::TranslateText("Ce mois") }}</span>
                        <h2 class="title"> {{ \App\Helpers\TranslationHelper::TranslateText("Produits les plus vendus") }}</h2>
                    </div>
        ...
        <div class="axil-product-area bg-color-white axil-section-gap pb--0">
            <div class="container">
                <div class="product-area pb--80">
                    <div class="section-title-wrapper">
                        <span class="title-highlighter highlighter-primary"> <i class="far fa-shopping-basket"></i> {{ \App\Helpers\TranslationHelper::TranslateText("Nos produits") }}</span>
                        <h2 class="title"> {{ \App\Helpers\TranslationHelper::TranslateText("Explorez nos produits") }}</h2>
                    </div>
