                        ...
                        <div class="card-body card-bodyx text-center ">
                            <h5 class="text-success">
                              ...
                              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="150" height="150" viewBox="0 0 48 48">
                                ...
                                <b>
                                 <h6>  Félicitation pour votre commande !</h6>  
                                </b>
                            </h5>
                            <br>
                            <p>
                                <h6> Votre commande a été enregistrée avec succès.</h6>
                            </p>
                            
                          
                            <div class="order-id">
                             
                                <a href="/shop" class="btn btn"  style=" background-color: #390ff622;">
                                    <h6>   Continuer les achats </h6>
                                </a>
