                ...
                <tbody>
                    @foreach ($commande->contenus as $contenu)
                        <tr>
                            ...
                            <td>
                                <input type="number" name="prix_unitaire" value="{{ $contenu['prix_unitaire'] }}"
                                    class="form-control"
                                    wire:change="updatePrix({{ $contenu['id'] }}, $event.target.value)">
                            </td>
                            <td>
                                @if ($commande->statut != 'retournée' && $commande->statut != 'payée')
                                    <div class="input-group mb-3" style="width: 120px !important">
                                        ...
                                        {{--  <input type="text" readonly value="{{ $contenu->quantite }}"
                                            class="form-control"> --}}
                                        <input type="text" name="quantite" value="{{ $contenu->quantite }}"
                                            class="form-control"
                                            wire:change="updateQuantite({{ $contenu['id'] }}, $event.target.value)">
                                        <button class="btn btn-outline-secondary" type="button"
