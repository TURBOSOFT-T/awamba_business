...
class ListDevis extends Component
{
    ...
    public $date, $statut, $key, $gouvernoratsTunisie, $gouvernorat, $statut2, $note;
    ...
    public function render()
    {
      ...
      /*   if (strlen($this->sur_devis) > 0) {
            $commandesQuery->where('sur_devis', $this->sur_devis);
        } */
        ...
        return view('livewire.devis.list-devis', compact("commandes", "total"));
    }
    ...
    public function delete($id)
    {
        ...
        return view('livewire.devis.list-devis');
    }
