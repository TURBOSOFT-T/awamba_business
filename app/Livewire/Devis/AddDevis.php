...
class AddDevis extends Component
{
    ...
    public $key, $nom, $pays, $prenom, $frais,$tax, $adresse, $gouvernorat, $phone, $recherche, $clients = [];
    public $quantites = [];
    public $produits = [];
...
public function delete_from_session($produitId)
{
    ...
    public function render()
    {
        ...
        if (!is_null($this->key)) {
            $produits = Produits::where('sur_devis', true)
        ...
        return view('livewire.devis.add-devis', compact('paniers'));
    }
    ...
    public function order()
    {
      ...
      //      $commande->pays = $this->pays;
            ...
            $commande->tax = $this->tax ? $config->tax : null;
